...
class BigIntegerCalculatorTests {
  ...
  @BeforeEach
  void init() {
    calculate = new BigIntegerOperation("489376583975638392234277384", "487394572398457329457489537129380123");
  }
  ...
  @DisplayName("곱셈")
  void multiplyTest() {
    assertEquals(calculate.multiply(), "238519490888624019359755491028456186644519216126524260758038232");
  }
